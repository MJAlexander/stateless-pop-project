...
mod <- cmdstan_model(here("code/kenya_shona/2_dirichlet_init/projection2.stan"))
...
write_rds(to_save, here("output/intermediate/kenya_shona_projection2_with_data.rds"))
